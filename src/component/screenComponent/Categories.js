  ...
  const categories = [
    {
      ...
      intro:
        'The symbol of the whole United States in general and the symbol of New York City in particular, the Statue of Liberty is definitely a place you will not be able to ignore in all your trips to this city. You can absolutely climb to the crown of the goddess to see the city or can use the ferry on the Hubson River to see the goddess.',
    },
    {
      id: 2,
